# Contributing to react-coffee-delivery

> Welcome to `react-coffee-delivery`
...
Please start by reading our [license](https://github.com/whosramoss/react-coffee-delivery/blob/master/LICENSE) and [code-of-conduct](https://github.com/whosramoss/react-coffee-delivery/blob/master/CODE_OF_CONDUCT.md). If you don't agree with them, this isn't your project.
...
Main contribution ways are to [open issues](https://github.com/whosramoss/react-coffee-delivery/issues) and [fork with later pull requests](https://github.com/whosramoss/react-coffee-delivery/network/members). Furthermore, you can discuss issues, review **PRs** or mention this project in _public/chat_ with the community about your experience.
